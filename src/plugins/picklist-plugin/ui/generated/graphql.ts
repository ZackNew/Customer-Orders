...
export const UpsertInvoiceConfigDocument = gql`
  ...
  upsertInvoiceConfig(input: $input) {
    ...
    `;
export const InvoiceConfigDocument = gql`
    query invoiceConfig {
  invoiceConfig {
    id
    enabled
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    upsertInvoiceConfig(variables: UpsertInvoiceConfigMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpsertInvoiceConfigMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpsertInvoiceConfigMutation>(UpsertInvoiceConfigDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'upsertInvoiceConfig', 'mutation', variables);
    },
    invoiceConfig(variables?: InvoiceConfigQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<InvoiceConfigQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<InvoiceConfigQuery>(InvoiceConfigDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'invoiceConfig', 'query', variables);
    }
  };
}
